 ...
 * 查看解说工作流
 */
export const getWorkflow = async ({ commentary_id }) => {
	return request({
		url: `${process.env.VUE_APP_URL_COMMENTARY}/movie_commentary/get_workflow`,
		method: "GET",
		params: {
			commentary_id
		}
 ...
 * 初始化解说缓存
 */
export const initCache = async ({ commentary_id }) => {
	return request({
		url: `${process.env.VUE_APP_URL_COMMENTARY}/movie_commentary/init_cache`,
		method: "POST",
		params: {
			commentary_id
		}
